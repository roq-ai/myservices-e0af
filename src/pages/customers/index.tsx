...
export function CustomerListPage(props: CustomerListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCustomers({
        relations: ['user', 'address.count', 'equipment.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('address', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'address',
          header: 'Address',
          accessorKey: 'address',
          cell: ({ row: { original: record } }: any) => record?._count?.address,
        }
      : null,
